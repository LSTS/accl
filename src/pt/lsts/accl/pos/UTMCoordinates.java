...
public class UTMCoordinates {
	...
	public UTMCoordinates(double easting, double northing, int zone_number,
			char zone_letter) {
	...
	public void LLtoUTM() {
		...
		double UTMEasting = (k0 * N * (A + (1 - T + C) * A * A * A / 6.0d + (5
				- 18 * T + T * T + 72 * C - 58 * eccPrimeSquared)
	...
	/*
	 * public final static double radToDeg(double rad) { return (rad * (180.0d /
	 * Math.PI)); }
	 */
